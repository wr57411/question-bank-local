...
| 功能移除（8 项 + 相似题 + ocr-server） | 移除 AI教学/书库/Wiki/悬浮窗/待处理/待补拍/专题/相似题/ocr-server；SQL 表全保留；同步键摘除；删 6 个废弃分支；-8700 行 | docs/plans/2026-09-04-feature-removal.md | 2026-09-04 | 功能移除, 同步, 服务端路由, E2E, 分支清理 |
